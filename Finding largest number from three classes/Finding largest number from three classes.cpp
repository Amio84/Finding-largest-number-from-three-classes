...
Class_Three::Class_Three(int n3)
{
	Number3 = n3;
}
...
void find_greatest_number(Class_One obj1, Class_Two obj2, Class_Three obj3)
{
	...
	{
		cout << "Largest number is " << obj1.Number1 << endl;
	}
	else if (obj2.Number2 > obj1.Number1 && obj2.Number2 > obj3.Number3)
	{
		cout << "Largest number is " << obj2.Number2 << endl;
	}
	else
	{
		cout << "Largest number is " << obj3.Number3 << endl;
	}
